...
// Create blocks
function cwt_register_custom_blocks() {
...
add_action('acf/init', 'cwt_register_custom_blocks' );

/*
 * Only load Featherlight scripts if team member block is present
 */

function cwt_teamblock_featherlight_script() {
...
// add_action( 'wp_enqueue_scripts', 'cwt_teamblock_featherlight_script' );

/*
 * Hide Genesis page title when Page Title block is used
 */

function cwt_hide_h1() {
...
//add_action( 'genesis_before_entry', 'cwt_hide_h1' );
