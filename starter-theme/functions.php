...
define( 'CHILD_THEME_NAME', 'CoreWeb Starter' );
define( 'CHILD_THEME_URL', 'https://websitename.com/' );
define( 'CHILD_THEME_VERSION', '1.0' );

add_action( 'wp_enqueue_scripts', 'cwt_enqueue_scripts_styles' );
function cwt_enqueue_scripts_styles() {
 ...
 * Editor stylesheet
 */
function cwt_editor_layout_style() {
...
add_action( 'enqueue_block_editor_assets', 'cwt_editor_layout_style' );

/** 
 * Gutenberg scripts and styles
 */
function cwt_editor_styling_scripts() {
...
add_action( 'enqueue_block_editor_assets', 'cwt_editor_styling_scripts' );
...
function cwt_responsive_menu_settings() {
...
function cwt_hide_scrollreveal() {
	?>
	<style>
		html.sr .load-hidden,
 ...
 *
 */
function cwt_google_tag_manager_head() {
	?>
	<!-- Google Tag Manager -->
	
	<?php
}
add_action( 'wp_head', 'cwt_google_tag_manager_head', 0 ); 

function cwt_google_tag_manager_body() {
	?>
	<!-- Google Tag Manager (noscript) -->

	<?php
}
add_action( 'genesis_before', 'cwt_google_tag_manager_body', 0 ); 
